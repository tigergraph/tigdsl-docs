...
In particular, the following are their groups of isomorphically equivalent vertices:
...
+
--
We can see in the results that vertices that are isomorphically equivalent have the same label.
For example, Wyatt and Dolores have the same label.
[,json]
----
[
  {
