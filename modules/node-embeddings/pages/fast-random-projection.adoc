...
[source,gsql]
----
CREATE QUERY tg_fastRP( SET<STRING> v_type_set,  SET<STRING> e_type_set,
    STRING weight_attributes, FLOAT beta, INT k, INT reduced_dim,
    INT sampling_constant, INT random_seed, BOOL print_results=FALSE,
