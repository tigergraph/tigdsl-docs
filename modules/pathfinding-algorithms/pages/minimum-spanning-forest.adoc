...
Given an undirected graph with one or more connected components, a minimum spanning forest is a set of minimum spanning trees, one for each component. The library implements the algorithm in section 6.2 of Qin et al. 2014: link:http://www-std1.se.cuhk.edu.hk/~hcheng/paper/SIGMOD2014qin.pdf[Scalable Big Graph Processing in MapReduce]
