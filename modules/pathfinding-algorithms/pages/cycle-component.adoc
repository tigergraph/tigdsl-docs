...
It returns only these vertices, which saves memory compared to finding and returning all cycles.
...
This query returns the vertices that appear on a cycle in JSON format.
